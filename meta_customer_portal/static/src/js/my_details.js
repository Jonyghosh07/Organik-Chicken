odoo.define('meta_customer_portal.portal', function (require) {
'use strict';
...
publicWidget.registry.websiteCustomerPortal = publicWidget.Widget.extend({
    ...
    _onChangeState: function () {
        ...
        console.log("called sub area", $("select[name='sub_area_id']"));
    ...
    _onChangeArea: function () {
        ...
        this._rpc({
            ...
            var selectSubAreas = $("select[name='sub_area_id']");
